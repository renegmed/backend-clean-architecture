...
func (_m *SignupUsecase) Create(ctx context.Context, user *domain.User) error {
...
func (_m *SignupUsecase) GetUserByEmail(ctx context.Context, email string) (domain.User, error) {
